          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 255, 160, 8),
                  ...
                  ElevatedButton(
                    onPressed: () {},
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 255, 171, 14),
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(5.0)),
                    ),
                    child: Padding(
              ...
              ReadMoreText(
                ...
                trimLines: 3,
                colorClickableText: Color.fromARGB(255, 255, 159, 14),
                trimMode: TrimMode.Line,
                trimCollapsedText: 'Show more',
                trimExpandedText: 'Show less',
                moreStyle:
                    const TextStyle(fontSize: 15, color: Color.fromARGB(255, 253, 178, 14)),
              ),
              const SizedBox(height: 30),
              Expanded(
                  ...
                  child: IconButton(
                      ...
                      icon: widget.recipe.favourite
                          ? const Icon(FluentIcons.heart_28_filled,
                              size: 25, color: Color.fromARGB(255, 238, 178, 14))
                          : const Icon(FluentIcons.heart_28_regular,
                              size: 25, color: Color.fromARGB(255, 255, 187, 14))),
                ),
              ),
              Positioned(
                  top: 40,
                  ...
                  child: InkWell(
                      ...
                      child: const CircleAvatar(
                        backgroundColor: Color.fromARGB(255, 255, 195, 14),
                        radius: 30,
